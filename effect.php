...
<div class="container">
  ...
  <div class="row mt-4">
    ...
    <div class="row mt-4">
      <div class="col-md-12">
        <h2 class="text-center">Add Class/Remove</h2>
      </div>
    </div>
    <div class="row mt-4">
      <div class="col-md-6">
        <img src="img/sochi01.jpg" class="img-fluid imgcircle" id="pic1">
        <button class="btn btn-lg btn-info mt-4" id="btnadd"> Add Class </button>
      </div>
      <div class="col-md-6">
       <img src="img/sochi02.jpg" class="img-fluid" id="pic2">
        <button class="btn btn-lg btn-info mt-4" id="btnremove"> Remove </button>
      </div>
    </div>
 <div class="row mt-4">
      <div class="col-md-12">
    ...
    <div class="row">
     <div class="col-md-6">
        <div class="divtext">
          <p class="abzac">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quia dolore repellat odio aliquid voluptatem velit magnam quisquam officiis saepe doloremque!</p>
       </div>
       <button class="btn btn-lg btn-info btn-default mt-4" id="switchbtn"> Switch </button>
     </div>
      <div class="col-md-6">
